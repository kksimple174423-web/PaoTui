...
enum URL {
    ...
    detailByTask = '/api/order/detailByTask',
}
...
const detailByTaskApi = async (params: any) =>
    get<any>({url: URL.detailByTask, params: params, data: {}, headers: {}});
...
export {listApi, userOrderListApi, detailByTaskApi, createApi, updateApi, deleteApi, cancelApi, cancelUserOrderApi};