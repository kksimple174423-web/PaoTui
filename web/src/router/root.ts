...
const constantRouterMap = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'publish',
        name: 'publish',
        component: () => import('/@/views/index/publish.vue')
      },
      {
        path: 'confirm',
        name: 'confirm',
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'wishTaskView',
            name: 'wishTaskView',
            component: () => import('/@/views/index/user/wish-task-view.vue')
          },
          {
            path: 'collectTaskView',
            name: 'collectTaskView',
            component: () => import('/@/views/index/user/collect-task-view.vue')
          },
          {
            path: 'orderView',
            name: 'orderView',
          ...
          },
          {
            path: 'runnerView',
            name: 'runnerView',
            component: () => import('/@/views/index/user/runner-view.vue')
          },
          {
            path: 'runnerVerifyView',
            name: 'runnerVerifyView',
            component: () => import('/@/views/index/user/runner-verify-view.vue')
          },
          {
            path: 'walletView',
            name: 'walletView',
            component: () => import('/@/views/index/user/wallet-view.vue')
          },
          {
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'runnerVerify', name: 'runnerVerify', component: () => import('/@/views/admin/runner-verify.vue') },
      { path: 'withdraw', name: 'withdraw', component: () => import('/@/views/admin/withdraw.vue') },
