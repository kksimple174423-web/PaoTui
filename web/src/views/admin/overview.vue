      ...
      <a-row :gutter="[20,20]">
        <a-col :sm="24" :md="12" :lg="6">
          <a-card size="small" title="任务总数">
            ...
            <div class="box">
              <div class="box-top">
                <span class="box-value">{{ tdata.data.spzs }}<span class="v-e">个</span></span>
              </div>
              <div class="box-bottom">
                <span>本周新增 {{ tdata.data.qrxz }} 个</span>
              </div>
            </div>
          </a-card>
        </a-col>
        ...
        <a-col :sm="24" :md="12" :lg="6">
          <a-card size="small" title="已完成订单">
            <template #extra>
              <a-tag color="blue" slot="extra">已完成</a-tag>
            </template>
            <div class="box">
              <div class="box-top">
        ...
        <a-col :sm="24" :md="12" :lg="6">
          <a-card size="small" title="已取消订单">

            <template #extra>
              <a-tag color="green" slot="extra">已取消</a-tag>
            </template>
...
<!--          <a-card title="热门任务排名" style="flex:1;">-->
...
const initBarChart = () => {
  let xData = ['待接单', '已接单', '配送中', '已送达', '已完成', '已取消']
  let yData = [
    tdata.data.taskWaiting || 0,
    tdata.data.taskAccepted || 0,
    tdata.data.taskDelivering || 0,
    tdata.data.taskArrived || 0,
    tdata.data.taskFinished || 0,
    tdata.data.taskCanceled || 0
  ]
