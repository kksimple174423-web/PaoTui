<template>
  <div class="main-bar-view">
    ...
    <div class="right-view">
      <a style="line-height: 32px;width:70px;cursor:pointer;" @click="$router.push({name:'publish'})">发布任务</a>
      ...
      <div class="right-icon" @click="handleOpenNotice">
          ...
          <a-spin :spinning="loading" style="min-height: 200px;">
            <div class="notice-list">
              <div class="notice-item" v-for="item in noticeData" :key="item.id">
                ...
                <div class="notice-time">{{ getFormatTime(item.createTime, true) }}</div>
              </div>
              <div v-if="noticeData.length === 0 && !loading" class="notice-empty">暂无消息</div>
            </div>
          </a-spin>
        </a-drawer>
      </div>
