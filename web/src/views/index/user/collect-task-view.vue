<template>
  <div class="content-list">
    ...
    <div class="list-content">
      <div class="collect-task-view">
        <div class="task-list flex-view">
          <div class="task-item item-column-3" v-for="(item,index) in pageData.collectData" :key="index">
            <div class="remove" @click="handleRemove(item)">移出</div>
            <div class="img-view" @click="handleClickItem(item)">
              <img :src="item.cover">
            </div>
            <div class="info-view">
              <h3 class="task-name">{{item.title}}</h3>
...
import {userCollectListApi, unCollectApi} from '/@/api/taskCollect'
