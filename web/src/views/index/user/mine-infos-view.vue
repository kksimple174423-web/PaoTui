  ...
  <div class="mine-infos-view">
    ...
    <div class="counts-view">
      <div class="counts flex-view">
        <div class="fans-box flex-item" @click="clickMenu('collectTaskView')">
          <div class="text">收藏</div>
          <div class="num">{{collectCount}}</div>
        </div>
        <div class="split-line">
        </div>
        <div class="follow-box flex-item" @click="clickMenu('wishTaskView')">
...
<!--        </div>-->
    ...
    <div class="order-box">
      ...
      <div class="list">
        ...
        <div class="mine-item flex-view" @click="clickMenu('walletView')">
          <img :src="MyOrderImg">
          <span>我的钱包</span>
        </div>
        <div class="mine-item flex-view" @click="clickMenu('runnerView')">
          <img :src="MyOrderImg">
          <span>骑手工作台</span>
        </div>
        <div class="mine-item flex-view" @click="clickMenu('runnerVerifyView')">
          <img :src="MyOrderImg">
          <span>骑手认证</span>
        </div>
...
import CommentIconImg from '/@/assets/images/order-task-icon.svg'
...
import {userCollectListApi} from '/@/api/taskCollect'
import {userWishListApi} from '/@/api/taskWish'
